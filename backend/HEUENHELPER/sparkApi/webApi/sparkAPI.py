...
def gen_params(appid, query, domain, role):
    ...
    elif role == 'to_do_list_teacher':
        content = "你是一个擅长总结每天任务情况的管理大师，你现在的任务是总结一位老师每天的任务情况。""任务要求：1、避免出现总结内容与任务内容不符。2、如果老师有很多任务未完成，提醒老师加快速度。3、站在老师的角度上来考虑问题。"
    elif role == 'diary':
